...
ELang v0.44.0 — статически типизированный, компилируемый системный язык программирования с expression-oriented синтаксисом. Компилируется напрямую в x86_64 ассемблер (NASM), создаёт нативные Linux бинарники без runtime overhead.
